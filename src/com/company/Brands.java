...
public class Brands {
...

    {
        ...
        brandslist.add("Dodge");
        brandslist.add("Fiat");
        brandslist.add("Ford");
        brandslist.add("GMC");
        brandslist.add("Genesis");
        brandslist.add("Honda");
        brandslist.add("Hyundai");
        brandslist.add("Infiniti");
        brandslist.add("Jaguar");
        brandslist.add("Jeep");
        brandslist.add("Kia");
        brandslist.add("Land Rover");
        brandslist.add("Lexus");
        brandslist.add("Lincoln");
        brandslist.add("Lotus");
        brandslist.add("Lucid");
        brandslist.add("Maserati");
        brandslist.add("Mazda");
        brandslist.add("Mercedes-Benz");
        brandslist.add("Mercury");
        brandslist.add("Mini");
        brandslist.add("Mitsubishi");
        brandslist.add("Nissan");
        brandslist.add("Polestar");
        brandslist.add("Pontiac");
        brandslist.add("Porsche");
        brandslist.add("Ram");
        brandslist.add("Rivian");
        brandslist.add("Rolls-Royce");
        brandslist.add("Saturn");
        brandslist.add("Scion");
        brandslist.add("Smart");
        brandslist.add("Subaru");
        brandslist.add("Suzuki");
        brandslist.add("Tesla");
        brandslist.add("Toyota");
        brandslist.add("Volkswagen");
        brandslist.add("Volvo");
        brandslist.add("Seat");
        brandslist.add("Skoda");
        brandslist.add("Trabant");
        brandslist.add("Talbot");
        brandslist.add("Wartburg");
        brandslist.add("Renault");
        brandslist.add("Peugeot");
        brandslist.add("Opel");
        brandslist.add("Lancia");
        brandslist.add("LDV");
        brandslist.add("Lada");
